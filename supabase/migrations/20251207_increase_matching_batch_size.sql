-- ============================================================================
-- Increase Matching Batch Size
-- ============================================================================
-- Increase from 50 to 150 users per run to improve throughput
...
COMMENT ON FUNCTION process_matching IS 'Optimized matching function with increased batch size (150 users) for better throughput under load.';
