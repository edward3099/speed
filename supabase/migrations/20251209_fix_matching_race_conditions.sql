-- ============================================================================
-- Fix Matching Race Conditions - Add Advisory Locks
-- ============================================================================
-- CRITICAL FIX: Add advisory locks to process_matching() to prevent race conditions
-- Based on analysis finding user matched multiple times and no locks in function
-- ============================================================================
-- 
-- Problem: process_matching() has NO locks, allowing concurrent processes to
-- match the same users simultaneously, causing:
-- - Duplicate matches
-- - Users matched multiple times
-- - State inconsistencies
-- 
-- Solution: Add advisory locks BEFORE any checks (lock-first pattern)
-- ============================================================================
