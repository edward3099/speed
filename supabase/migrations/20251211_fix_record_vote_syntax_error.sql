-- Fix record_vote function syntax error
-- Issue: Cannot use INTO v_re_read.user1_vote syntax - PostgreSQL doesn't support field-level assignment in SELECT INTO
-- Solution: Use INTO v_match.user1_vote, v_match.user2_vote directly
...
BEGIN
  ...
  -- Select directly into v_match fields to update the record (FIX: was using invalid v_re_read syntax)
