...
import { showWarning } from "@/lib/utils/show-error"
...
export default function landing() {
  ...
  const handleOnboardingComplete = async () => {
    ...
    try {
      ...
      // Convert city to array format for preferences
      const cityArray = Array.isArray(onboardingData.city) 
        ? (onboardingData.city.length > 0 ? onboardingData.city : null)
        : (onboardingData.city ? [onboardingData.city] : null)
      
      const preferencesData = {
        user_id: userId,
        min_age: onboardingData.minAge,
        max_age: onboardingData.maxAge,
        city: cityArray, // Save as array or null
