-- Fix join_queue function to ensure user_status exists
...
COMMENT ON FUNCTION join_queue IS 'Joins user to queue - validates online, cooldown, duplicates - ensures user_status exists';
